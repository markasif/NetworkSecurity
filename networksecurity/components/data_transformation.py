...
class DataTransformation:
    ...
    def get_data_transfomer_object(cls) -> Pipeline:
        ...
        """"
        it initialises a KNNimputer  object with the parameter specified in the traning_pipeline.py file and 
        return a Pipeline object with the KNNImputer object as the first step
        ...
        try:
             ...
             logging.info(f"Initialize KNNImputer with {DATA_TRANSFORMED_IMPUTER_PARAMS}")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            ##removing dependent columns[traget column]
